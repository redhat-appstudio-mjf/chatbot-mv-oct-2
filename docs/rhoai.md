...
2) Go to the `Data Science Projects` section and access your application's project named `chatbot-mv-oct-2`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `chatbot-mv-oct-2-notebook`.
...
5) In the terminal, run `cd chatbot-mv-oct-2` to navigate to your sample app's directory.
